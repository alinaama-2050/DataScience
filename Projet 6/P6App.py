    ...
    if request.method == 'POST':
        if (request.form):
            ...
            try:
                ...
                print(prob_result)
                predictions = {
                    "class0": class_result[0],
                    "class1": class_result[1],
                    "class2": class_result[2],
                    "class3": class_result[3],
                    "class4": class_result[4],
                    "class5": class_result[5],
                    "class6": class_result[6],
                    "class7": class_result[7],
                    "class8": class_result[8],
                    "class9": class_result[9],
                    "class10": class_result[10],
                    "class11": class_result[11],
                    "prob0": prob_result[0],
                    "prob1": prob_result[1],
                    "prob2": prob_result[2],
                    "prob3": prob_result[3],
                    ...
                    "prob8": prob_result[8],
                    "prob9": prob_result[9],
                    "prob10": prob_result[10],
                    "prob11": prob_result[11]
